...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <%= Html.LabelEditorValidationItemFor(model => model.Marca)%>
		<%= Html.LabelEditorValidationItemFor(model => model.Modelo) %>
        <%= Html.DropDownListItemFor(model => model.CategoriaBici.ID, Model.CategoriaBici.ToEntitySelectList())%>
